...
public class ParentExistsExecutor
{
    private static final Logger LOG = LoggerFactory.getLogger( ParentExistsExecutor.class );

    private final NodeService nodeService;

    private final StorageSpyService storageSpyService;

    public ParentExistsExecutor( final NodeService nodeService, final StorageSpyService storageSpyService )
    {
